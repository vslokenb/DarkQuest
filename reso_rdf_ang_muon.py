...
def cal_reso(file_names,bins = [-300,42]):
    rdf = ROOT.RDataFrame("Events", file_names).Define("truthang_xz","ang_xz(truthtrack_pz_st3, truthtrack_pz_st3, truthtrack_px_st3)").Define("ang_xz","ang_xz(track_pz_st3, truthtrack_pz_st3, track_px_st3)")
...
plt.savefig(f'final_batch/fast_reso_ang_pxpz_muon_{args.type}_{args.ecal}.pdf', format='pdf', bbox_inches="tight")
