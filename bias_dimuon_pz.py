...
plt.xlabel('dimuon truth pz [GeV]')
plt.ylabel('pz bias (mean difference) [GeV]')
#plt.ylim(-0.5,0.4)
plt.legend()
plt.title('J/Psi dimuon pz bias for different st3 position (disp track)')

# Save and show the plot
plt.savefig('matched/dimuon_binned_pz_bias_matched_all_geom_disp.pdf', format='pdf')
plt.show()
