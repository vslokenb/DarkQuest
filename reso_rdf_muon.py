...
files=[f"/seaquest/users/xinlongl/semi-persistent/geom_change/m0_dis_{args.type}_{args.nominal}/reco_displaced_mu*.root",
       f"/seaquest/users/xinlongl/semi-persistent/geom_change/m100_dis_{args.type}_{args.nominal}/reco_displaced_mu*.root",
       f"/seaquest/users/xinlongl/semi-persistent/geom_change/m200_dis_{args.type}_{args.nominal}/reco_displaced_mu*.root",
       f"/seaquest/users/xinlongl/semi-persistent/geom_change/m0_dis_original_{args.nominal}/reco_displaced_mu*.root"]#[f"0cm_shift_standard_{args.type}/reco_standard_JPsi*.root",f"100cm_shift_standard_{args.type}/reco_standard_JPsi*.root",f"200cm_shift_standard_{args.type}/reco_standard_JPsi*.root",f"/seaquest/users/xinlongl/semi-persistent/geom_change/m0_std_original_{args.nominal}/reco_standard_JPsi*.root"]
axis=np.arange(5,95,10)
...
plt.ylabel('pz resolution muon gun with angular match [GeV]')
plt.ylim(0,5)
plt.legend()
plt.title('Muon pz resolution at st3 (dis tracking)')



# Save and show the plot
plt.savefig(f'fast_reso/fast_reso_angmask_muon_{args.type}_{args.nominal}.pdf', format='pdf')
plt.show()
