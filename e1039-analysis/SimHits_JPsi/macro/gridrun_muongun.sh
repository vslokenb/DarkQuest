...
ls
time root -b -q RecoE1039Sim_muongun.C\($n_events,5,1,$z_vtx,true,true,false,\"\",\"\",\"reco_muongun_"$EMCal_pos"_"$St3_pos_dif".root\",\"./\",\"/pnfs/e1039/persistent/users/apun/bkg_study/e1039pythiaGen_26Oct21/10_bkge1039_pythia_wshielding_100M.root\",0,$EMCal_pos,$St3_pos_dif\)

echo RecoE1039Sim_muongun.C\($n_events,5,1,$z_vtx,true,true,false,\"\",\"\",\"reco_muongun_$z_vtx.root\",\"./\",\"/pnfs/e1039/persistent/users/apun/bkg_study/e1039pythiaGen_26Oct21/10_bkge1039_pythia_wshielding_100M.root\",0,$EMCal_pos,$St3_pos_dif\)
ls
RET=$?
if [ $RET -ne 0 ] ; then
