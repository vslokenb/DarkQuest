...
private:
  ...
  int mainDMRecoed;
    ...
    int hit_elmid[5000];
    int hit_trkid[5000];
    float hit_driftdis[5000];
    float hit_pos[5000];
    float hit_edep[5000];
    float hit_truthx[5000];
    float hit_truthy[5000];
    float hit_truthz[5000];
    float hit_truthpx[5000];
    float hit_truthpy[5000];
    float hit_truthpz[5000];
