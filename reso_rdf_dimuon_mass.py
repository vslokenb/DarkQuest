...
plt.xlabel('truth dimuon z vtx [cm]')
plt.ylabel('mass resolution (stdev) [GeV]')
plt.ylim(0,1)
plt.legend()
plt.title('Dimuon mass resolution  (dis tracking)')



# Save and show the plot
plt.savefig(f'fast_reso/fast_reso_match_dimuon_mass_dis_{args.type}_{args.nominal}.pdf', format='pdf')
plt.show()
