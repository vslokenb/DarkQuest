...
plt.ylabel(r'$\sigma (mass)$ [GeV]')
plt.ylim(0,1)
plt.legend()
plt.title('Dimuon mass resolution  (std tracking)')



# Save and show the plot
plt.savefig(f'final_batch/fast_reso_match_dimuon_mass_std_{args.type}_{args.ecal}.pdf', format='pdf', bbox_inches="tight")
