...
files=[f"/seaquest/users/xinlongl/semi-persistent/geom_change/m0_dis_{args.type}_{args.nominal}/reco_displaced_mu*.root",
       ...
       f"/seaquest/users/xinlongl/semi-persistent/geom_change/m0_dis_original_{args.nominal}/reco_displaced_mu*.root"]
...
plt.ylim(0,1)
plt.legend()
plt.title('Muon efficiency x acceptance (dis tracking)')



# Save and show the plot
plt.savefig(f'fast_eff_angmask_mu_{args.type}_{args.nominal}.pdf', format='pdf')
plt.show()
