...
directories = [
    '/seaquest/users/xinlongl/semi-persistent/jpsi/pro_m0_v2_std_1/',
    '/seaquest/users/xinlongl/semi-persistent/jpsi/pro_m50_v2_std_1/',
    '/seaquest/users/xinlongl/semi-persistent/jpsi/pro_m100_v2_std_1/',
    '/seaquest/users/xinlongl/semi-persistent/jpsi/pro_m200_v2_std_1/'
]
...
def number_sort(file,directory):
    version = re.search(r'pro_m(\d+)_v2_std_1', directory)
...
plt.ylabel('mass bias (mean difference) [GeV]')
plt.ylim(-0.5,0.4)
plt.legend()
plt.title('J/Psi dimuon mass bias for different st3 position (standard track)')

# Save and show the plot
plt.savefig('matched/dimuon_binned_mass_bias_matched_all_geom_standard.pdf', format='pdf')
plt.show()
