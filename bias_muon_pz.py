...
directories = [
    '/seaquest/users/xinlongl/semi-persistent/muongun/pro_m0_v2/',
    '/seaquest/users/xinlongl/semi-persistent/muongun/pro_m50_v2/',
    '/seaquest/users/xinlongl/semi-persistent/muongun/pro_m100_v2/',
    '/seaquest/users/xinlongl/semi-persistent/muongun/pro_m200_v2/'
]
...
plt.xlabel('muon truth pz [GeV]')
plt.ylabel('pz bias (mean difference) [GeV]')
#plt.ylim(-0.5,0.4)
plt.legend()
plt.title('Muon track st3 pz bias for different st3 position (disp track)')

# Save and show the plot
plt.savefig('matched/muon_binned_pz_bias_matched_all_geom_disp.pdf', format='pdf')
plt.show()
